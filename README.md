...
4. Na primeira execução de qualquer usuário, o app cria automaticamente uma planilha chamada **"Mapeamento de Marcas - Banco de Projetos"** no Google Drive da conta que a criar primeiro — é ali que todos os projetos, colaboradores e conteúdos ficam armazenados. Não é necessário criar essa planilha manualmente.
